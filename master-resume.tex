...
\vspace{1mm}
    ...
    \begin{tightitemize} \itemsep -1mm
            ...
            \item Self-taught \textbf{Jetpack Compose} and \textbf{MVVM} patterns to accelerate onboarding and contribute to the Chase Android app, installed over \textbf{100M+ times}
            ...
            \item Applied modern Android practices (Glide for async images, Kotlin coroutines) to enhance maintainability and user experience

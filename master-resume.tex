...
\vspace{1mm}
    ...
    \begin{tightitemize} \itemsep -1mm
            ...
            \item Self-taught \textbf{Jetpack Compose} and \textbf{MVVM} patterns to accelerate onboarding and contribute to the Chase Android app, installed more than \textbf{100M+ times}
            
            \item Built a new merchandising tile template leveraging Adobe Experience Manager (AEM) data and developed an internal debugging tool allowing developers to dynamically swap between all merchandising templates
            
            \item Led the transition of my team's merchandising tiles to Jetpack Compose, enabling more flexible layouts and improving developer experience
            
            \item Applied modern Android practices (Glide for async images, Kotlin coroutines, design system integration, automated testing) to enhance maintainability and user experience

...
\header[More at naj-dev.com]{Projects}
    ...
    \begin{tightitemize} \itemsep -1mm
        ...
        \item Built a backend system that uses \textbf{NLP techniques} and Python's \texttt{Counter} to compare user resumes and job descriptions, scoring overlap to recommend best-fit internal roles; designed for future LLM integration
